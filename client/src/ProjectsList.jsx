        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th scope="col">Сложность реализации</th>
              <th scope="col">Срочность выполнения</th>
              <th scope="col"></th>
            </tr>
          </thead>

          {getAllProjects.map((el, i) => (
            <tbody>
              <tr className="align-middle">
                ...
                <td className="text-end">
                  <button
                    ...
                    onClick={() => handleTaskEditor(el._id)}
                  >
                    <svg
                  ...
                  <button
                    ...
                    onClick={() => handleRemoveTask(el._id)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
